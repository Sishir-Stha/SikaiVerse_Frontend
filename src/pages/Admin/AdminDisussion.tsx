...
import { ArrowLeft, MessageCircle, Send, Heart, Shield, Plus, Loader2, X } from 'lucide-react'
import {
  getCourseList,
  getDiscussion,
  type CourseList,
            ...
            <div className="md:col-span-2">
              {!selectedCourseId ? (
                ...
                <Card className="card-enhanced">
                  <CardContent className="pt-12 text-center pb-12">
                    <Loader2 size={32} className="animate-spin text-destructive mx-auto mb-4" />
                ...
                <div className="space-y-4 animate-fade-in-up">
                  ...
                  {/* New Post Form */}
                  {showNewPostForm && (
                    <Card className="card-enhanced border-destructive/50">
                      <CardHeader>
                        <div className="flex items-center gap-2">
                        ...
                        <CardDescription>
                          Start a new discussion topic as an admin
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        ...
                        />
                        <textarea
                          placeholder="Describe your topic or announcement..."
                          value={newPostContent}
                          onChange={e => setNewPostContent(e.target.value)}
                          disabled={isCreatingPost}
                          className="w-full p-3 border border-border rounded-md bg-background text-foreground min-h-28 resize-y focus:outline-none focus:ring-2 focus:ring-destructive"
                          autoFocus
                        />
                                  ...
                                  {post.repliesDataList.map(reply => (
                                    <div
                                      ...
                                      className={`rounded-lg p-3 ${
                                        reply.replyUserRole?.toLowerCase() === 'admin'
                              ...
                              <div className="mt-4 space-y-3 p-4 bg-destructive/10 rounded-lg border border-destructive/30">
                                ...
                                <div className="flex gap-2">
                                  <Button
                                    ...
                                    disabled={!adminReplyContent.trim() || isPostingReply}
                                    className="gap-2"
                                  >
                                    {isPostingReply ? (
